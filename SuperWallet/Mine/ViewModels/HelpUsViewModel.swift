...
struct HelpUsViewModel {
    ...
    private let sharingText: [String] = [
        ...
        NSLocalizedString(
            ...
            value: "Check out SuperWallet - the wallet that lets me securely store my Ethereum and ERC20 tokens.",
            comment: ""
        ),
        NSLocalizedString(
            "welldone.viewmodel.sharing.text3",
            value: "I securely store Ethereum and ERC20 tokens in the SuperWallet wallet",
            comment: ""
        ),
        NSLocalizedString(
            "welldone.viewmodel.sharing.text4",
            value: "I secure my Ethereum and ERC20 tokens in the SuperWallet wallet.",
            comment: ""
        )
    ]    
}
